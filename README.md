...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pdbfixer-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11423&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pdbfixer-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pdbfixer` can be installed with:

```
conda install pdbfixer
```

It is possible to list all of the versions of `pdbfixer` available on your platform with:
